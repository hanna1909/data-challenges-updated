...
class TestPackageVersion(TestBase):
    ...
    def test_package_version(self):
        ...
        assert "cloud_prediction" in package_summary, "the `taxifare-model` package version is not correct, please run `make reinstall_package` to reinstall the package"
