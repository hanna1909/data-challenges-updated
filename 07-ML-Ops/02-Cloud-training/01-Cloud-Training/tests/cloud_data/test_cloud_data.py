...
class TestCloudData(TestBase):
    ...
    def test_cloud_data_uploaded_blob(self):
        ...
        assert int(training_content_length) == 1000287, "the uploaded file does not seem to be the correct size"
        ...
        assert int(validation_content_length) == 999661, "the uploaded file does not seem to be the correct size"
