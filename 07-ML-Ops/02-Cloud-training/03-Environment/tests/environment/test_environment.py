...
class TestDirenv(TestBase):
    ...
    def test_local_data_path(self):
        ...
        data_path_match = re.compile(".*/.lewagon/mlops/data$").match(local_data_path)
    ...
    def test_local_registry_path(self):
        ...
        registry_path_match = re.compile(".*/.lewagon/mlops/training_outputs$").match(local_registry_path)
